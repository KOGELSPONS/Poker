function setup() {
  //Canvas
    ...
    background(255);
    frameRate(Frate);
    playerProfile1 = new PlayerProfile(100,100,200,200, "Player1", 500);
    playerProfile2 = new PlayerProfile(100,410,200,200, "Player2", 500);
    playerProfile3 = new PlayerProfile(900,100,200,200, "Player3", 500);
    playerProfile4 = new PlayerProfile(900,410,200,200, "Player4", 500);
  //Sound
